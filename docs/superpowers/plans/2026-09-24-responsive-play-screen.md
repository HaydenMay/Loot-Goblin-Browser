...
- [x] **Step 3: Implement the tested layout helper and Phaser scene**
...
- [x] **Step 5: Commit the responsive room task**
...
- [x] **Step 1: Write failing joystick math tests**
...
- [x] **Step 2: Run the test and confirm the missing-helper failure**
...
- [x] **Step 3: Implement the joystick math helper**
...
- [x] **Step 4: Run the math tests and confirm they pass**

Run: `node --experimental-strip-types --test tests/joystick-math.test.ts`
Expected: all four joystick math tests pass.

- [x] **Step 5: Write failing pointer-controller tests**
...
- [x] **Step 6: Run the pointer-controller test and confirm it fails for the missing module**
...
- [x] **Step 7: Implement and test the pure pointer controller**
...
- [x] **Step 8: Write failing HUD and DOM pointer tests**
...
- [x] **Step 9: Run the UI-control test and confirm the missing-module failure**
...
- [x] **Step 10: Implement the HUD and DOM pointer adapter**
...
- [x] **Step 11: Run the full unit suite and production build**

Run: `npm test && npm run build`
Expected: all layout and joystick tests pass, TypeScript and Vite build exit 0.

- [x] **Step 12: Commit and push the completed Stage 2 implementation to `main`**

Commit message: `feat: add floating touch joystick and minimal hud`

## Final Verification

- [x] Run `npm test && npm run build` and read the complete output.
- [x] Use the connected browser on the deployed Pages route to capture the available viewport screenshot, inspect the play screen, and click Pause then Resume; review browser console errors.
- [x] Confirm mobile viewport geometry with the layout unit test. If local Playwright Chromium is unavailable, report that detailed multi-size browser screenshots and real iPhone touch still need a device/browser run.
- [x] Verify production build assets use the `/Loot-Goblin-Browser/` base path.
- [x] Check the deployed `/Loot-Goblin-Browser/` route after push and report that iPhone Safari still needs the user's on-device confirmation.
